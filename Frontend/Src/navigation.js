(function () {
    ...
    var NAV_LINKS = [
        ...
        { href: 'teachers.html', label: 'Teachers', icon: '👨‍🏫', roles: ['admin', 'headmaster'] },
        { href: 'attendance-management.html', label: 'Attendance', icon: '📋', roles: [] },
        { href: 'academic-records.html', label: 'Results', icon: '📄', roles: [] },
        { href: 'reports-dashboard.html', label: 'Reports', icon: '📈', roles: [] },

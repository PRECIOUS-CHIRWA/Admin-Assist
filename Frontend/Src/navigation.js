...
(function () {
    ...
    var ICONS = {
        ...
        timetable: '<svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>',
    ...
    var PAGE_TITLES = {
        ...
        'enroll-student.html': 'Student Enrollment',
        'students.html': 'Students & Accounts',
        'teachers.html': 'Staff Management',
        'timetable-management.html': 'Timetable Management',

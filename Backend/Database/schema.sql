...
CREATE TABLE IF NOT EXISTS results (
    ...
    final_term_score    DECIMAL(5,2)                DEFAULT NULL,
    continuous_assessment_score DECIMAL(5,2)        DEFAULT NULL,
    ...
    status              VARCHAR(30)        NOT NULL DEFAULT 'INCOMPLETE', -- 'COMPLETE', 'INCOMPLETE', 'PENDING_APPROVAL', 'APPROVED'
    assessment_policy_snapshot TEXT                 DEFAULT NULL,
    teacher_comment     TEXT                        DEFAULT NULL,
    class_position      SMALLINT UNSIGNED           DEFAULT NULL, -- class rank for this subject/term
    created_at          TIMESTAMP          NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at          TIMESTAMP          NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
    FOREIGN KEY (school_id)        REFERENCES schools(id)        ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS school_settings (
    ...
    academic_year_label     VARCHAR(20)           DEFAULT '2026',
    address                 TEXT                  DEFAULT NULL,
    phone                   VARCHAR(30)           DEFAULT NULL,
    email                   VARCHAR(255)          DEFAULT NULL,
    ...
    assessment_model        VARCHAR(50)  NOT NULL DEFAULT 'MID_TERM_FINAL',
    mid_term_weight         DECIMAL(5,2) NOT NULL DEFAULT 20.00,
    final_term_weight       DECIMAL(5,2) NOT NULL DEFAULT 80.00,
    continuous_assessment_enabled TINYINT(1) NOT NULL DEFAULT 0,
    continuous_assessment_weight  DECIMAL(5,2) NOT NULL DEFAULT 0.00,
    grading_scheme          VARCHAR(50)  NOT NULL DEFAULT 'ADMIN_ASSIST_ECZ',
